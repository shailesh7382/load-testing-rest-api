...
The complete OpenAPI 3.0 specification is available in `openapi.yaml` at the root of the repository.
...
- **Swagger UI**: Can be integrated into the application (see below)
- **Redoc**: https://redocly.github.io/redoc/ (load `openapi.yaml`)
