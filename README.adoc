...
- **fx-api-client**: Client-side code generation from OpenAPI specification
- **fx-api-server-stub**: Server-side stub generation from OpenAPI specification
- **fx-api-test**: API testing and validation using OpenAPI specification
...
├── fx-api-client/              # Client code generation module
│   ├── pom.xml                 # Module POM file
│   └── README.md               # Client documentation
├── fx-api-server-stub/         # Server stub generation module
│   ├── pom.xml                 # Module POM file
│   └── README.md               # Server stub documentation
└── fx-api-test/                # API testing module
    ├── pom.xml                 # Module POM file
...
== OpenAPI Code Generation Modules

The project includes three additional modules that leverage the OpenAPI specification for code generation and testing.

=== fx-api-client: Client SDK Generation

Generates a Java client SDK from the OpenAPI specification.

**Building the client:**
[source,shell]
----
mvn clean compile -pl fx-api-client
----
...
See `fx-api-client/README.md` for detailed documentation and usage examples.

=== fx-api-server-stub: Server Stub Generation

Generates Spring Boot server stubs (interfaces) from the OpenAPI specification.

**Building the stubs:**
[source,shell]
----
mvn clean compile -pl fx-api-server-stub
----

**Usage:** Implement the generated interfaces in your Spring Boot application to ensure API contract compliance.

See `fx-api-server-stub/README.md` for detailed documentation and usage examples.

=== fx-api-test: API Contract Testing

Provides comprehensive API testing and validation using the OpenAPI specification.

**Running the tests** (requires the API to be running on http://localhost:8080):
[source,shell]
----
...
mvn test -Dmaven.test.skip=false -pl fx-api-test
----

**Test coverage includes:**

- Contract tests for all Quote API endpoints
- Contract tests for all Trade API endpoints
- Basic endpoint validation tests

See `fx-api-test/README.md` for detailed documentation and test descriptions.
